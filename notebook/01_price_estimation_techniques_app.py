...
def main():
    yield mo.md(
        r"""
        # 🍊 Fair Pricing: Classical vs Quantum Estimation (Marimo App)

        This interactive app demonstrates the difference between classical Monte Carlo and quantum amplitude estimation for fair pricing of orange juice under uncertainty.
        """
    )
